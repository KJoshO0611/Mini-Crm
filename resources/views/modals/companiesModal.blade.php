<!-- Delete Modal -->
<div class="modal fade" id="companyDelete" tabindex="-1" role="dialog" aria-labelledby="companyDeleteLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header bg-danger">
          <h5 class="modal-title" id="companyDeleteLabel">Delete Company</h5>
...
<!-- Edit Modal -->
<div class="modal fade" id="companyEdit" tabindex="-1" role="dialog" aria-labelledby="companyNewLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h5 class="modal-title" id="companyNewLabel">Edit Company</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
